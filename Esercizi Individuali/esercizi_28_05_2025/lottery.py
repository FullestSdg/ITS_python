...
class LotteryMachine:
    ...
    def __init__(self) -> None:
        ...
        self.biglietto_vincente: list[str] = [] 

    def draw_winning_ticket(self) -> None:
        
        while len(self.biglietto_vincente) < 4:

            pulled:str = choice(self.pool)

            if pulled not in self.biglietto_vincente:
                self.biglietto_vincente.append(pulled)

    def announce_winner(self) -> None:

        print("The winning ticket is:", self.biglietto_vincente)
