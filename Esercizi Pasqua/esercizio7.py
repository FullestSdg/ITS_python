...
entrambi espressi mediante ore, minuti e secondi. La funzione time_difference deve usare la funzione seconds_since_noon per calcolare
...
def seconds_since_noon(ore:int, minuti:int, secondo:int) -> int:
    pass